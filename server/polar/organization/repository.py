...
class OrganizationRepository(
    ...
    async def get_creators_with_products(
        ...
        *,
        ...
        Returns organizations with product count for the creators directory.
        Only includes non-blocked organizations.
        Eagerly loads products for counting.
        """
        statement = (
            self.get_base_statement()
            ...
            .options(joinedload(Organization.products))
            .limit(limit)
            .offset(offset)
        )
        return await self.get_all(statement)
    ...
    async def get_by_slug_public(
        ...
        Only returns non-blocked organizations.
        Eagerly loads products for the storefront.
        """
        statement = (
            self.get_base_statement()
            .where(
    ...
    async def update_profile(
        ...
        *,
        ...
        Args:
            ...
            flush: Whether to flush changes to the database
        ...
        if social_links is not None:
            update_dict["social_links"] = social_links

        return await self.update(organization, update_dict=update_dict, flush=flush)
