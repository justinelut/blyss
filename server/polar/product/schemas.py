...
class ProductPriceCreateBase(Schema):
    ...
    price_currency: PriceCurrency = PresentmentCurrency.kes
...
class CreatorInfo(Schema):
    """Creator information for product detail page"""

    id: UUID4 = Field(description="The ID of the creator organization.")
    name: str = Field(description="The name of the creator.")
    slug: str = Field(description="The slug of the creator.")
    avatar_url: str | None = Field(description="The avatar URL of the creator.")
    bio: str | None = Field(description="The bio of the creator.")


class ReviewSummary(Schema):
    """Review summary for product detail page"""

    average_rating: float = Field(description="Average rating of the product.")
    total_count: int = Field(description="Total number of reviews.")


class ProductDetailPublic(MetadataOutputMixin, ProductBase):
    """
    Product detail schema with creator information and review summary.
    ...
    creator: CreatorInfo = Field(description="Creator information.")
    review_summary: ReviewSummary = Field(description="Review summary.")
