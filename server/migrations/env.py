...
def include_object(object, name, type_, reflected, compare_to):
    ...
    # Exclude PGGrantTable entities from autogenerate
    # This prevents alembic-utils from tracking database grants
    if type_ == "unique_constraint" and name and name.startswith("_"):
        # This is how alembic-utils marks its entities
        return False

    # Check if this is a PGGrantTable by checking the object type
