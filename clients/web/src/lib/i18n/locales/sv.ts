  ...
  checkout: {
    footer: {
      ...
      mandateSubscriptionTrial:
        'Genom att klicka på "{buttonLabel}" godkänner du att Blyss, vår återförsäljare och registrerade handlare, debiterar din valda betalningsmetod med beloppet som visas ovan vid slutet av din provperiod och vid varje efterföljande faktureringsdatum tills du säger upp prenumerationen. Du kan när som helst säga upp prenumerationen innan provperioden löper ut för att undvika debitering.',
      mandateSubscription:
        'Genom att klicka på "{buttonLabel}" godkänner du att Blyss, vår återförsäljare och registrerade handlare, omedelbart debiterar din valda betalningsmetod med beloppet som visas ovan och debiterar samma belopp vid varje efterföljande faktureringsdatum tills du säger upp prenumerationen.',
      mandateOneTime:
        'Genom att klicka på "{buttonLabel}" godkänner du att Blyss, vår återförsäljare och registrerade handlare, debiterar din valda betalningsmetod med beloppet som visas ovan. Detta är en engångsdebitering.',
    },
    form: {
      email: 'Email',
