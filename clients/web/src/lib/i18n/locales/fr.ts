  ...
  checkout: {
    footer: {
      ...
      mandateSubscriptionTrial:
        "En cliquant sur « {buttonLabel} », vous autorisez Blyss, notre revendeur en ligne et marchand officiel, à débiter votre moyen de paiement sélectionné du montant indiqué ci-dessus à la fin de votre période d'essai et à chaque date de facturation ultérieure jusqu'à annulation. Vous pouvez annuler à tout moment avant la fin de votre essai pour éviter d'être débité.",
      mandateSubscription:
        "En cliquant sur « {buttonLabel} », vous autorisez Blyss, notre revendeur en ligne et marchand officiel, à débiter immédiatement votre moyen de paiement sélectionné du montant indiqué ci-dessus et à débiter le même montant à chaque date de facturation ultérieure jusqu'à annulation.",
      mandateOneTime:
        "En cliquant sur « {buttonLabel} », vous autorisez Blyss, notre revendeur en ligne et marchand officiel, à débiter votre moyen de paiement sélectionné du montant indiqué ci-dessus. Il s'agit d'un paiement unique.",
    },
    form: {
      email: 'E-mail',
