  ...
  checkout: {
    footer: {
      ...
      mandateSubscriptionTrial:
        'Ao clicar em "{buttonLabel}", você autoriza a Blyss, nossa parceira de vendas online, a cobrar em sua forma de pagamento selecionada o valor exibido acima ao final do seu período de teste e em cada data de cobrança subsequente até que você cancele. Você pode cancelar a qualquer momento antes do final do teste para evitar a cobrança.',
      mandateSubscription:
        'Ao clicar em "{buttonLabel}", você autoriza a Blyss, nossa parceira de vendas online, a cobrar imediatamente em sua forma de pagamento selecionada o valor exibido acima e a cobrar o mesmo valor em cada data de cobrança subsequente até que você cancele.',
      mandateOneTime:
        'Ao clicar em "{buttonLabel}", você autoriza a Blyss, nossa parceira de vendas online, a cobrar em sua forma de pagamento selecionada o valor exibido acima. Esta é uma cobrança única.',
    },
    form: {
      email: 'E-mail',
