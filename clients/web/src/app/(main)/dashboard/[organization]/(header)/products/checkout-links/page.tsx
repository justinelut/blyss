...
export default async function Page(props: {
  ...
  // If there's a newest checkout link: on desktop redirect to it (always
  // show the detail pane), on mobile render nothing so the list view is
  // visible by itself. Without this, mobile renders both panes side-by-
  // side and overflows.
