  ...
  return (
    ...
    >
      <p className="dark:text-polar-500 text-gray-500">
        Manage the people who have access to this shop. Shop team members can
        manage shop settings, products, subscriptions, and orders.
      </p>
      ...
      <ConfirmModal
        ...
        description={`Are you sure you want to remove ${memberToRemove?.email} from this shop?`}
        destructive
      ...
      <ConfirmModal
        ...
        description={`Are you sure you want to leave ${organization.name}? You will lose access to this shop.`}
        destructive
    ...
    try {
      ...
      if (result.response.status == 200) {
        toast({
          ...
          description: "This person is already a member of the shop team",
        });
      } else if (result.data) {
        toast({
          title: "Member added",
