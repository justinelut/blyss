...
Click **Buy now** on any product. Pay with your card or M-Pesa. Your purchase appears under [**Your purchases**](/orders), and you can re-download files any time.

### Where do my files go?

Digital downloads are linked to your Blyss account email. Sign in at [blyss.co.ke/login](/login) and go to [**Your purchases**](/orders) to access them. Subscription benefits (Discord access, members-only feeds) are also managed from there.
