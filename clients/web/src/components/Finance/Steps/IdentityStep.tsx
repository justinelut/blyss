      ...
      <StepCard>
        <div className="space-y-4">
          <div className="space-y-4 text-center">
            <div className="dark:bg-polar-800 rounded-lg bg-[var(--surface)] p-8">
              {identityVerificationStatus === 'pending' ? (
                <>
                  <h4 className="mb-2 font-medium">
                    Identity Verification Pending
                  </h4>
                  <p className="dark:text-polar-400 mx-auto mb-6 max-w-md text-sm text-[var(--text-secondary)]">
                ...
                <>
                  ...
                  <p className="dark:text-polar-400 mx-auto text-sm text-[var(--text-secondary)]">
                    Your identity has been successfully verified.
                  </p>
                </>
              ) : identityVerificationStatus === 'failed' ? (
                ...
                <>
                  <div className="mb-4 flex justify-center">
                    <div className="dark:bg-polar-900/30 flex h-8 w-8 items-center justify-center rounded-full bg-[var(--surface)]">
                      <CheckCircle className="dark:text-polar-400 h-4 w-4 text-[var(--text-secondary)]" />
                    </div>
                  </div>
