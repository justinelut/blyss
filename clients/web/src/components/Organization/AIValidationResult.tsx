    ...
    switch (result.verdict) {
      case "PASS":
        return {
          ...
          message: "Your business details passed the acceptable use review.",
          ...
          <Card className={`rounded-lg p-4`}>
            <div className="flex items-start space-x-3">
              ...
              <div className="flex-1">
                ...
                <p className={`dark:text-polar-400 mt-1 text-sm text-gray-600`}>
                  {status.type === "pass"
                    ? "Your business details passed the initial compliance check. A manual review may still occur before your first payout as part of the standard process."
                    : status.type === "review_required"
                      ? "Payments are currently blocked for your shop due to our compliance review. You can submit an appeal below if you believe this decision is incorrect."
                      : "Please wait while we validate your business details."}
                </p>
              </div>
            </div>
          </Card>
