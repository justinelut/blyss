...
# Reload Nginx to enable HTTP for certbot
...
echo ""
echo "Next steps:"
echo "1. Add DNS A record: $API_DOMAIN → 129.80.136.152"
echo "2. Wait for DNS to propagate (1-5 minutes)"
echo "3. Update backend .env to use: https://$API_DOMAIN"
echo ""
