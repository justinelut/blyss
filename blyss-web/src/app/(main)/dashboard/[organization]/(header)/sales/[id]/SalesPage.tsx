      ...
      <ShadowBox className="dark:divide-polar-700 flex flex-col divide-y divide-gray-200 border-gray-200 bg-transparent p-0 md:rounded-3xl!">
        <div className="flex flex-col gap-6 p-4 md:p-8">
          <div className="flex flex-col gap-1">
            ...
            {/* Platform fee information for Paystack orders */}
            {order.platform_fee_amount && order.platform_fee_amount > 0 && (
              <>
                ...
                />
                <DetailRow
                  label="Creator Payout (80%)"
                  value={formatCurrency('accounting')(
                    order.creator_payout_amount ||
                      order.total_amount - order.platform_fee_amount,
                    order.currency,
                  )}
                />
                <DetailRow
                  ...
                  value={
                    <div className="flex items-center gap-2">
                      ...
                      <Status
                        status="Paystack"
                        className="bg-green-100 text-xs text-green-600 dark:bg-green-950"
                      />
                    </div>
                  }
                />
