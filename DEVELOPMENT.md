...
The platform uses Blyss brand assets for logos, favicons, and social media images. These can be customized through environment variables.
...
- `blyss-og-image.png` - Social media Open Graph image

**Email Assets** (`server/emails/assets/`):
- `blyss-logo-email.png` - Logo for email templates

### Environment Variables

Configure brand-related settings in your environment files:
...
**Frontend** (`clients/apps/web/.env.local`):
```
...
> [!TIP]
> For complete brand asset documentation, including specifications, usage guidelines, and troubleshooting, see [docs/BRAND_ASSETS.md](docs/BRAND_ASSETS.md).
